...
@interface NTESBypassTypeSelectViewController ()

@end

@implementation NTESBypassTypeSelectViewController
...
- (IBAction)selectRoomBypassType:(id)sender {
    NTESLiveTypeSelectViewController *vc = [[NTESLiveTypeSelectViewController alloc]initWithBypassType:NTESBypassTypeRoom];
    vc.modalPresentationStyle =  UIModalPresentationFullScreen;
    [self.navigationController pushViewController:vc animated:YES];
}

- (IBAction)selectAnchorBypassType:(id)sender {
    NTESLiveTypeSelectViewController *vc = [[NTESLiveTypeSelectViewController alloc]initWithBypassType:NTESBypassTypeAnchor];
    vc.modalPresentationStyle =  UIModalPresentationFullScreen;
    [self.navigationController pushViewController:vc animated:YES];
}
